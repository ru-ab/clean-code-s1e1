...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="task-item__input text-input";

  editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
  editButton.className="task-item__button task-item__button_edit button";

  deleteButton.className="task-item__button task-item__button_delete button";
...
var editTask=function(){
  ...
  var editBtn=listItem.querySelector(".task-item__button_edit");
...
//select ListItems children
  ...
  var editButton=taskListItem.querySelector(".task-item__button_edit");
  var deleteButton=taskListItem.querySelector(".task-item__button_delete");
